# This Makefile is for the DBIx::ModelUpdate extension to perl.
#
...
TO_INST_PM = ModelUpdate.pm \
	ModelUpdate/Oracle.pm \
	ModelUpdate/mysql.pm

PM_TO_BLIB = ModelUpdate.pm \
	$(INST_LIBDIR)/ModelUpdate.pm \
	ModelUpdate/mysql.pm \
	$(INST_LIBDIR)/ModelUpdate/mysql.pm \
	ModelUpdate/Oracle.pm \
	$(INST_LIBDIR)/ModelUpdate/Oracle.pm
...
manifypods : pure_all ModelUpdate.pm
	@$(POD2MAN) \
	ModelUpdate.pm \
	$(INST_MAN3DIR)/DBIx::ModelUpdate.$(MAN3EXT)
...
realclean purge ::  clean
	...
	rm -f  $(INST_LIBDIR)/ModelUpdate.pm $(INST_LIBDIR)/ModelUpdate/mysql.pm
	rm -f $(INST_LIBDIR)/ModelUpdate/Oracle.pm
